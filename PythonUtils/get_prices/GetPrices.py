...
# 实时汇率api
cover_url="https://free.currconv.com/api/v7/convert?q={}&compact=ultra&apiKey=eff1240539fa23bc7474"
...
def __sendEMail(text,mailTo):
    ...
    message["From"]="hhlass <{}>".format(sender)
...
def getNowPrice():
    ...
    for item in jk_iterms["all"]:
        ...
        if url.startswith("https://www.amazon.com"):
            ...
            product,nprice=__taobaoGet(url)
        if nprice<pt and nprice>0.00:
